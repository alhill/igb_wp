                                ...
                                <td width="15%">
                                  <div onclick="javascript:showbigcalendar('bigcalendar<?php echo $many_sp_calendar; ?>','<?php 
                                    echo add_query_arg(array(
									  ...
									  'cat_ids' => $cat_ids,
                                      'widget' => $widget,
                                      ), $site_url);?>','<?php echo $many_sp_calendar; ?>','<?php echo $widget; ?>')" style="text-align:center; cursor:pointer; visibility: hidden; width:100%; background-color: <?php echo hex_to_rgb($views_tabs_bg_color, 0.4) ?>;">
                                ...
                                <td style="margin:0; text-align:left; padding: 0px 0px 0px 30px !important;" width="11%" class="cala_arrow">
                                  ...
                                  <td width="15%">
                                    <div onclick="javascript:showbigcalendar('bigcalendar<?php echo $many_sp_calendar; ?>','<?php
									  ...
									  'cat_ids' => $cat_ids,
                                      'widget' => $widget,
                                      ), $site_url);?>','<?php echo $many_sp_calendar; ?>','<?php echo $widget; ?>')" style="text-align:center; cursor:pointer; width:100%; display:none; background-color: <?php echo hex_to_rgb($views_tabs_bg_color, 0.4) ?>;">
                                      <span style="font-size:18px; color:#FFF"><?php echo $year + 1; ?></span>
                                    </div>
                                  </td>
                                </tr>
