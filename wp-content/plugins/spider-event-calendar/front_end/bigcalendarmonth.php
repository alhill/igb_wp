...
///////////////////////////////////////////////////////////////////////////////////////////////////////
  ...
  $top_height = $theme->top_height;
        //MODIFICACIÓN GUARRA DE LA ALTURA DEL TÍTULO DE LA TABLA
        $top_height *= 0.6;
                          ...
                          <td width="10%">
                            <div onclick="javascript:showbigcalendar('bigcalendar<?php echo $many_sp_calendar; ?>','<?php 
                              echo add_query_arg(array(
								...
								'cat_ids' => $cat_ids,
                                'widget' => $widget,
                                ), $site_url);?>','<?php echo $many_sp_calendar; ?>','<?php echo $widget; ?>')" style="text-align:center; cursor:pointer; visibility: hidden; width:100%; <?php echo $years_bgcolor; ?>;">
...
if (in_array($i, $array_days)) {
  ...
  if ($weekday_i != 1) {
    for ($i = $weekday_i; $i <= 7; $i++) {
      if ($i != 7) {
        echo '        <td class="caltext_color_other_months" style="font-size:' . $other_days_font_size . 'px;line-height:2;font-family: Segoe UI;font-weight: 600;background-color:' . $bg_color_other_months . ' !important;"><p style="background: '.$date_bgcolor.';"><span style="padding: 0px 19px 0px 5px;">' . $next_i . '</span></p></td>';
      }
      else {
        echo '        <td class="caltext_color_other_months" style="font-size:' . $other_days_font_size . 'px;line-height:2; font-weight: 600;font-family: Segoe UI; background-color:' . $bg_color_other_months . ' !important;"><p style="background: '.$date_bgcolor.';"><span style="padding: 0px 19px 0px 5px;">' . $next_i . '</span></p></td>';
      }
      $next_i += 1;
    }
  }
